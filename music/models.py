...
class TrackFeature(models.Model):
    MOOD_CHOICES = [('happy', 'Happy'), ('sad', 'Sad'), ('energetic', 'Energetic'),
                    ('calm', 'Calm'), ('romantic', 'Romantic'), ('angry', 'Angry'), ('chill', 'Chill')]
...
class Interaction(models.Model):
    ...
    interaction_type = models.CharField(max_length=10, choices=INTERACTION_TYPES, default='stream')
